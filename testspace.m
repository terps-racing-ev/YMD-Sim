...
%% "Traditional" Plots - Data Stratification
    ...
    poly8 = polyfit(log(FzRange),CoF8,1);
    poly10 = polyfit(log(FzRange),CoF10,1);
    poly12i = polyfit(log(FzRange),CoF12i,1);
    poly12f = polyfit(log(FzRange),CoF12f,1);
    poly14 = polyfit(log(FzRange),CoF14,1);
