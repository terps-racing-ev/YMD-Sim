classdef TREV3Parameters
    ...
    methods
        ...
        function obj = TREV3Parameters()
            
            [~, name, ext] = fileparts('TREV3 Cookbook.xlsx');
            tempTREV3Cookbook = fullfile('Reference Files/',['TREV3 Cookbook-MATLAB', ext]);
            copyfile('TREV3 Cookbook.xlsx', tempTREV3Cookbook);
            %data = readtable(tempTREV3Cookbook)

            parameters = readtable('TREV3 Cookbook-MATLAB','Sheet', 'Parameters','VariableNamingRule','preserve');
            points = readtable('TREV3 Cookbook-MATLAB','Sheet', 'Geo Points','VariableNamingRule','preserve');
            BRS = readtable('TREV3 Cookbook-MATLAB','Sheet', 'BRS Camber & Toe Gain','VariableNamingRule','preserve');
