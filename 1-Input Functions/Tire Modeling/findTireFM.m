...
<<<<<<< Updated upstream
            % mux(m,k) = model.muxFront.predictFcn([alphasD(m,k),tire.gammas(m,k),tire.FZ(m,k),tire.P(m,k)]);
            % muy(m,k) = model.muyFront.predictFcn([alphasD(m,k),tire.gammas(m,k),tire.FZ(m,k),tire.P(m,k)]);
=======
...
<<<<<<< Updated upstream
            % mux(m,k) = model.muxRear.predictFcn([alphasD(m,k),tire.gammas(m,k),tire.FZ(m,k),tire.P(m,k)]);
            % muy(m,k) = model.muyRear.predictFcn([alphasD(m,k),tire.gammas(m,k),tire.FZ(m,k),tire.P(m,k)]);
=======
