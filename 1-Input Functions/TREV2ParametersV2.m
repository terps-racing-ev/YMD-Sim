 ...
 properties (SetAccess = private)  
    ...
    methods
        ...
        function output = steerCamberLHS(~, x)
            % X and Y coordinates in matrix form 
            X = [TREV2ParametersV2.getProportion(-30) TREV2ParametersV2.getProportion(-25) TREV2ParametersV2.getProportion(-20) TREV2ParametersV2.getProportion(-15) TREV2ParametersV2.getProportion(-10) TREV2ParametersV2.getProportion(-5) TREV2ParametersV2.getProportion(0) TREV2ParametersV2.getProportion(5) TREV2ParametersV2.getProportion(10) TREV2ParametersV2.getProportion(15) TREV2ParametersV2.getProportion(20) TREV2ParametersV2.getProportion(25) TREV2ParametersV2.getProportion(30)];
        ...
        function graphRolls(~)
            ...
            subplot(3, 2, 1);
            TREV2ParametersV2.RollCFL_plot();
            title('Roll vs. Camber Front Left');

            subplot(3, 2, 2);
            TREV2ParametersV2.RollCFR_plot();
            title('Roll vs. Camber Front Right');
            
            subplot(3, 2, 3);
            TREV2ParametersV2.RollCRL_plot();
            title('Roll vs. Camber Rear Left');

            subplot(3, 2, 4);
            TREV2ParametersV2.RollCRR_plot();
            title('Roll vs. Camber Rear Right');

            subplot(3, 2, 5);
            TREV2ParametersV2.steerCamberLHS_plot();
            title("Steer vs. Camber LHS")

            subplot(3, 2, 6);
            TREV2ParametersV2.steerCamberRHS_plot();
    ...
    methods (Static)
        ...
        function output = steerCamberLHS_plot()
            ...
            X = [-90 TREV2ParametersV2.getProportion(-30) TREV2ParametersV2.getProportion(-25) TREV2ParametersV2.getProportion(-20) TREV2ParametersV2.getProportion(-15) TREV2ParametersV2.getProportion(-10) TREV2ParametersV2.getProportion(-5) TREV2ParametersV2.getProportion(0) TREV2ParametersV2.getProportion(5) TREV2ParametersV2.getProportion(10) TREV2ParametersV2.getProportion(15) TREV2ParametersV2.getProportion(20) TREV2ParametersV2.getProportion(25) TREV2ParametersV2.getProportion(30) 90];
